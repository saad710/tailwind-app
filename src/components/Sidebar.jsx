...
const Sidebar = () => {
    return (
        ...
        p-2 w-1/5  overflow-y-auto text-center bg-gray-900 shadow h-screen">
          <ul>
                <li className='m-2 p-2 text-gray-400 font-semibold hover:bg-yellow-400 hover:rounded-lg hover:text-slate-900 hover:p-2'>
                    Mobile Phone
                </li>
                <li  className='m-2 p-2 text-slate-900 font-semibold hover:bg-yellow-400 hover:rounded-lg hover:text-slate-900 hover:p-2'>
                    Mobile Phone
